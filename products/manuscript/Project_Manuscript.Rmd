...
```{r 6Fig, fig.cap="Number of Dengue Cases Weekly against Precipitation.", echo=FALSE}
...
```{r 7Fig, fig.cap="Number of Dengue Cases Weekly against the Mean Wind Speed.", echo=FALSE}
...
```{r 8Fig, fig.cap="Number of Dengue Cases Weekly against Maximum Wind Speed.", echo=FALSE}
...
```{r 9Fig, fig.cap="Number of Dengue Cases Weekly against Relative Humidity.", echo=FALSE}
...
```{r 10Fig, fig.cap="Number of Dengue Cases Weekly against Mean Visibility.", echo=FALSE}
...
```{r 11Fig, fig.cap="Correlation among Variables.", echo=FALSE}
...
_For the first part of this analysis, we examined a few variables against each other: Average temperature of the week (TEM), Relative humidity (H), Precipitation Level (PP), and Mean wind speed (V). We are looking for any general trends among these climate conditions._

```{r 12Fig, fig.cap="Comparison of Average Temperature versus Average Precipitation.", echo=FALSE}
knitr::include_graphics("../../results/Temp_vs_Precip.png")
```

```{r 13Fig, fig.cap="Comparison of Average Temperature versus Mean Windspeed.", echo=FALSE}
knitr::include_graphics("../../results/Temp_vs_MeanWS.png")
```

```{r 14Fig, fig.cap="Comparison of Average Temperature versus Relative Humidity.", echo=FALSE}
knitr::include_graphics("../../results/Temp_vs_Humid.png")
```

```{r 15Fig, fig.cap="Comparison of Average Precipitation versus the Mean Windspeed.", echo=FALSE}
knitr::include_graphics("../../results/Precip_vs_MeanWS.png")
```

```{r 16Fig, fig.cap="Comparison of Relative Humidity versus Average Precipitation.", echo=FALSE}
knitr::include_graphics("../../results/Humid_vs_Precip.png")
```

```{r 17Fig, fig.cap="Comparison of Relative Humidity versus Mean Windspeed.", echo=FALSE}
...
```{r 18Fig, fig.cap="Comparison of Average Temperature Across Years.", echo=FALSE}
knitr::include_graphics("../../results/Year_vs_Temp.png")
```

```{r 19Fig, fig.cap="Comparison of Average Temperature Across Each Week Continuously.", echo=FALSE}
knitr::include_graphics("../../results/WeekCont_vs_Temp.png")
```

```{r 20Fig, fig.cap="Comparison of Average Temperature Across Each Week of the Year.", echo=FALSE}
...
```{r 21Fig, fig.cap="Comparison of Average Precipitation Across Years.", echo=FALSE}
knitr::include_graphics("../../results/Year_vs_Precip.png")
```

```{r 22Fig, fig.cap="Comparison of Average Precipitation Across Each Week Continuously.", echo=FALSE}
knitr::include_graphics("../../results/WeekCont_vs_Precip.png")
```

```{r 23Fig, fig.cap="Comparison of Average Precipitation Across Each Week of the Year.", echo=FALSE}
...
```{r 24Fig, fig.cap="Comparison of Relative Humidity Across Years.", echo=FALSE}
knitr::include_graphics("../../results/Year_vs_Humid.png")
```

```{r 25Fig, fig.cap="Comparison of Relative Humidity Across Each Week Continuously.", echo=FALSE}
knitr::include_graphics("../../results/WeekCont_vs_Humid.png")
```

```{r 26Fig, fig.cap="Comparison of Relative Humidity Across Each Week of the Year.", echo=FALSE}
...
```{r 27Fig, fig.cap="Comparison of Mean Windspeed Across Years.", echo=FALSE}
knitr::include_graphics("../../results/Year_vs_Windspeed.png")
```

```{r 28Fig, fig.cap="Comparison of Mean Windspeed Across Each Week Continuously.", echo=FALSE}
knitr::include_graphics("../../results/WeekCont_vs_Windspeed.png")
```

```{r 29Fig, fig.cap="Comparison of Average Temperature Across Each Week of the Year.", echo=FALSE}
