...
7 - What additional variables would be beneficial to include in the dataset for future studies? For example, exact longitude, latitude, etc. 
...
-- Methods will include examining the variables in detail to see which ones are the best predictors and indicators for Dengue. Comparing each other variable to the number of cases will give us some decent figures to examine in order to make our analysis work. 
...
-- Our data did not need nearly any cleaning due to it being from another source that was using R script. We might clean some data later on if necessary, but I have not found any reason to do so just yet. 
