...
1 - Which variable/variables are the best indicators for Dengue?
...
-- Our data did not need nearly any cleaning due to it being from another source that was using R script save for an additional variable added to look at the collective of Weeks for each Year over the 5 Year Span. We might clean some more data or add more variables later on if necessary, but I have not found any reason to do so just yet. 
