...
Cases_v_SLP <- ggplot(colmozzie, aes(x = Cases, y = SLP, color = Cases)) + geom_jitter(alpha = 0.25) + ggtitle("Cases vs Sea Level Pressure") + xlab("Cases") + ylab("Sea Level Pressure") + theme(legend.position = "none", axis.text.x = element_text(face = "bold"))
