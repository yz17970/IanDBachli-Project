...
Cases_v_WeekContinuous <- ggplot(colmozzie, aes(x = Week, y = Cases, color = Week_Continuous)) + geom_violin(width = 1) + geom_jitter(alpha = 0.25) + ggtitle("Cases vs Week Continuous") + xlab("Weeks over 5 Years") + ylab("Cases") + theme(legend.position = "none", axis.text.x = element_text(face = "bold"))
